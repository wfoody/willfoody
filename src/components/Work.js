    ...
    <div className="container">
      ...
      <div className="workContainer">
        ...
        <div className="workItem">
          <img src={represent} className="projectImage" alt="Represent App screenshot" />
          <div className="projectImageText" style={{ color: color }}>A React/Redux web application designed as a platform to help you connect with your elected representatives. You can find this app online <a href="https://represent-project.netlify.app/" target="_blank" rel="noreferrer">here</a>, and on GitHub <a href="https://github.com/wfoody/Represent/" target="_blank" rel="noreferrer">here</a>.</div>
        </div>
        <div className="workItem">
          <img src={goodtutor} className="projectImage" alt="GoodTutor App screenshot" />
